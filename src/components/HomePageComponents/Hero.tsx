...
import her3 from "../../assets/3.png"
import her12 from "../../assets/12.png"
import her14 from "../../assets/14.png"
import her31 from "../../assets/31.png"
                ...
                <div className="heroChildOneHold flex-col flex justify-center items-center">
                    <div className="heroChild1">
                        ...
                        <div className="heroInnerChild1 flex flex-col gap-4">
                            ...
                            <p className=' font-semibold'>Crypto Currencies and tools in a single site <br />
                            </p>

                            <a href="https://twitter.com/halleluianft" target="_blank">
  <button className='flex justify-center items-center mt-8 w-36 h-10 rounded bg-black text-white font-semibold transition-all ease-in-out duration-500 hover:bg-transparent hover:border hover:text-black border-black'>
    Learn More
  </button>
</a>
                        </div>
                    ...
                    <div className="heroStatsHold bg-white text-black flex justify-center items-center lg:gap-20 gap-12 md:gap-8 w-full h-28 mt-16 sm:pl-0 sm:pr-0 pl-3 pr-3">
                        ...
                        <div className='heroStat1 pt-3 pb-3 font-semibold flex flex-col'>
                            <p className='md:text-2xl text-xl font-normal interFont'>$**</p>
                ...
                <div className="heroChildHold2 flex justify-center items-center">
                    ...
                    <div className="heroCarouselHold flex items-center">
                        <Marquee play={true} speed={80} pauseOnHover={true} gradient={false}>
                            ...
                            <Image src={her14} quality={100} priority className='heroCaroImage w-48' alt='Carousel image' />
                            ...
                            <Image src={her3} quality={100} priority className='heroCaroImage w-48' alt='Carousel image' />
                            <Image src={heroCarouselImage5} quality={100} priority className='heroCaroImage w-48' alt='Carousel image' />
                            <Image src={her12} quality={100} priority className='heroCaroImage w-48' alt='Carousel image' />
                            <Image src={heroCarouselImage6} quality={100} priority className='heroCaroImage w-48' alt='Carousel image' />
                            <Image src={her31} quality={100} priority className='heroCaroImage w-48' alt='Carousel image' />  
                        </Marquee>
                    </div>
                </div>
